...
product <- fread("C:/Users/akabo/Downloads/Pernalonga/product_table.csv")
transaction <- fread("C:/Users/akabo/Downloads/Pernalonga/transaction_table.csv")
...
transaction_product1<- transaction1[,.(sum(tran_prod_sale_amt)/sum(tran_prod_sale_qty),sum(tran_prod_sale_qty),
                                       (sum(tran_prod_offer_cts)/.N),mean(tran_prod_discount_amt/tran_prod_sale_amt)),
